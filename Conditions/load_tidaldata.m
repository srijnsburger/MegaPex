function [T1,T2]=load_tidaldata(varargin)
%% Load_tidaldata
...
[num,txt,raw] = xlsread('d:\sabinerijnsbur\Measurements\Measurements2013\STRAINS Dropbox\mfiles and mat files\AlexHD2\id1-HOEKVHLD-201302010000-201303092359.xlsx');
id = fopen('d:\sabinerijnsbur\Measurements\Measurements2013\STRAINS Dropbox\mfiles and mat files\AlexHD2\id1-HOEKVHLD-201302010000-201303092359.csv');
% test = textscan(id,'%s %s %s %n %n','Headerlines',60,'Delimiter',';');%2014
test = textscan(id,'%*s %*s %s %s %*s %n %*s %*s %*s %*s %*s %*s %*s %*s %*s %*s %*s %*s','Headerlines',14,'Delimiter',';');
...
[num2,txt2,raw2] = xlsread('d:\sabinerijnsbur\Measurements\Measurements2013\STRAINS Dropbox\mfiles and mat files\AlexHD2\id1-SCHEVNGN-201302010000-201303092359.xlsx');
id2              = fopen('d:\sabinerijnsbur\Measurements\Measurements2013\STRAINS Dropbox\mfiles and mat files\AlexHD2\id1-SCHEVNGN-201302010000-201303092359.csv');
% test2            = textscan(id2,'%s %s %s %n %n','Headerlines',60,'Delimiter',';');
test2 = textscan(id2,'%*s %*s %s %s %*s %n %*s %*s %*s %*s %*s %*s %*s %*s %*s %*s %*s %*s','Headerlines',14,'Delimiter',';');
